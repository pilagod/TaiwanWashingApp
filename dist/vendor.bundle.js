...
/***/ function(module, exports, __webpack_require__) {
	...
	var _banner = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./intro.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./intro.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BottomApp = (function (_Component) {
	  ...
	  function BottomApp() {
	    _classCallCheck(this, BottomApp);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(BottomApp).apply(this, arguments));
	  }

	  _createClass(BottomApp, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'section',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./bottomApp.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./bottomApp.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
